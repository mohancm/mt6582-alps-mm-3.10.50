...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dsi.fbk_div =17;    // 1  ,   1    32    // fref=26MHz, fvco=fref*(fbk_div+1)*2/(div1_real*div2_real)
}

static void lcm_init(void)
{
	Lcd_Log("MYCAT otm9605a lcm_init\n");
...
static unsigned int lcm_compare_id(void)
{
    ...
    printf("MYCAT otm9605a_ykl, id = 0x%08x\n", id);
     ...
     return ((0x9605 == id) && (0 == get_lcd_id())) ? 1 : 0;
}

// ---------------------------------------------------------------------------
//  Get LCM Driver Hooks
// ---------------------------------------------------------------------------
LCM_DRIVER otm9605a_suxian_S5001800A_BOE_dsi_2_qhd_lcm_drv =
{
    .name           = "otm9605a_suxian_S5001800A_BOE_dsi_2_qhd",
