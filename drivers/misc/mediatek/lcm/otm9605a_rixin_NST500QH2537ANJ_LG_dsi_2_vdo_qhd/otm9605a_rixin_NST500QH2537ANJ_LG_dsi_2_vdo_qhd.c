...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	{0x00,1,{0x90}},
	{0xCC,15,{0x00,0x10,0x04,0x02,0x00,0x00,0x00,0x00,0x00,0x00,0x25,0x26,0x21,0x22,0x00}},
...
{
//    Lcd_Log("\n %s \n",__func__);
///		lcm_initialization_setting[30].para_list[0] += 1;
...
static unsigned int lcm_esd_check(void)
{
	...
	if(lcm_esd_test)
  {
	...
	printk("mycat++++$$ otm9605a_rixin_NST500QH2537ANJ_LG_dsi_2_vdo_qhd_lcm_drv ### esd check id = 0x%x\r\n",id);
...
LCM_DRIVER otm9605a_rixin_NST500QH2537ANJ_LG_dsi_2_vdo_qhd_lcm_drv =
{
        .name			= "otm9605a_rixin_NST500QH2537ANJ_LG_dsi_2_vdo_qhd",
