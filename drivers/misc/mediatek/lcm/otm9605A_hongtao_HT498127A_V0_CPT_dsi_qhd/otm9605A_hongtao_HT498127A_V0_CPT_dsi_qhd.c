...
#if 1  // added by wanghe 2013-07-31 for esd shanping, important!!
		{0x00, 1, {0xA0}},
		{0xC1, 1, {0x00}}, 
...
LCM_DRIVER otm9605A_hongtao_HT498127A_V0_CPT_dsi_qhd_lcm_drv =
    {
        .name			= "otm9605A_hongtao_HT498127A_V0_CPT_dsi_qhd",
