...
{0x00,1,{0x90}},
{0xC5,2,{0xD6,0x79}},//VGH=15, VGL=-12
...
{0x00,1,{0x00}},
{0xE2,16,{0x02,0x10,0x16,0x0f,0x07,0x12,0x0A,0x09,0x04,0x08,0x09,0x08,0x0F,0x12,0x0E,0x08}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    // Video mode setting
    params->dsi.intermediat_buffer_num = 2;//2
...
{
    Lcd_Log("\n %s \n",__func__);
    //lcm_initialization_setting[67].para_list[0] += 2;
...
LCM_DRIVER otm9605a_ykl_LP047APTP025A_AUO_dsi_2_qhd_lcm_drv =
    {
        .name			= "otm9605a_ykl_LP047APTP025A_AUO_dsi_2_qhd",
